...
export default function LoginPage() {
  ...
  if (mode === 'sent') {
    return (
      <main className="mx-auto flex min-h-dvh max-w-md flex-col justify-center px-6 py-16">
        ...
        <button onClick={() => reset('signin')} className="mt-4 text-center text-sm text-chalk/40 underline-offset-2 hover:underline">
          Back to sign in
        </button>
      </main>
    );
  ...
  return (
    <main className="mx-auto flex min-h-dvh max-w-md flex-col justify-center px-6 py-16">
      ...
      <p className="mt-2 text-center text-sm text-chalk/35">
...
function Back() {
  return (
    <Link href="/" className="font-mono text-sm uppercase tracking-[0.35em] text-lime">
      ← SOTG Predictor
    </Link>
  );
}
